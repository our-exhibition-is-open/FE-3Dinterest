...
export function MainBackground(props) {
    ...
    return (
      <Canvas onClick={click} shadows dpr={[1, 1.5]} gl={{ antialias: false }} camera={{ position: [0, 0, 15], fov: 17.5, near: 1, far: 40 }} {...props}>
...
function Model({ children, color = 'white', roughness = 0, ...props }) {
  const ref = useRef()
  const { nodes, materials } = useGLTF('src/resource/background_model/c-transformed.glb')
  useFrame((state, delta) => {
